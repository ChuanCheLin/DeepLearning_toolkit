...
def parseXmlFiles(xml_list, xml_path):
    
    list_fp = open(xml_list, 'r')
    for line in list_fp:
        line = line.strip()
        print("Processing %s"%(line))
        f = os.path.join( line + '.xml')
...
if __name__ == '__main__':
    xml_path = './data0305/Annotations'
    xml_list = './data0305/ImageSets/Main/trainval.txt'
    json_file = './data0305/train.json'
    parseXmlFiles(xml_list, xml_path)
